    ...
    <div class="flex flex-row-reverse gap-4 relative items-center">
        <div class="relative">
            ...
            <div id="dropdownMenu" class="absolute border right-0 mt-2 w-48 bg-white rounded-lg shadow-lg opacity-0 invisible transition-all duration-300 transform scale-95 text-sm flex flex-col">
                <div class="p-2">
                    <a href="/profile" class="flex gap-1 items-center px-4 py-2 text-sm text-gray-800 hover:bg-gray-100 rounded-lg">
                        ...
                        Profile</a>
                    <a href="/settings" class="flex gap-1 px-4 py-2 text-sm text-gray-800 hover:bg-gray-100 rounded-lg">
