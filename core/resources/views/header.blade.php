<div class="flex justify-end w-full items-center px-4">
    <div class="flex flex-row-reverse gap-4 relative items-center">
        <div class="relative">
            ...
            <!-- Dropdown Menu -->
            <div id="dropdownMenu" class="absolute border right-0 mt-2 w-48 bg-white rounded-lg shadow-lg opacity-0 invisible transition-all duration-300 transform scale-95 text-sm flex flex-col">
                <div class="p-2">
                    <a href="/user/profile" class="flex gap-1 items-center px-4 py-2 text-sm text-gray-800 hover:bg-gray-100 rounded-lg">
                        <svg class="stroke-gray-900" width="20" height="20" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        Profile</a>
                    <a href="/user/setting" class="flex gap-1 px-4 py-2 text-sm text-gray-800 hover:bg-gray-100 rounded-lg">
                        <svg class="stroke-gray-900" width="20" height="20" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="">
                ...
                <div class="border-t p-2">
                    <button id="logoutButton" class="flex gap-1 w-full text-left px-4 py-2 text-sm text-gray-800 hover:bg-gray-100 rounded-lg">
                    <svg class="stroke-gray-900" width="20" height="20" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color=""><path d="M12 12H19M19 12L16 15M19 12L16 9" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M19 6V5C19 3.89543 18.1046 3 17 3H7C5.89543 3 5 3.89543 5 5V19C5 20.1046 5.89543 21 7 21H17C18.1046 21 19 20.1046 19 19V18" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>    
                    Logout</button>
                </div>
            </div>
        </div>
        ...
        <button class="rounded-full hover:bg-sky-100 transition-colors p-2 group bg-gray-100">
            <svg class="stroke-gray-500 group-hover:stroke-sky-500" width="22" height="22" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#6b7280">
        ...
        <button class="rounded-full hover:bg-sky-100 transition-colors p-2 group bg-gray-100">
            <svg class="stroke-gray-500 fill-gray-500 group-hover:stroke-sky-500 group-hover:fill-sky-500" width="22" height="22" viewBox="0 0 24 24" fill="" xmlns="http://www.w3.org/2000/svg">
