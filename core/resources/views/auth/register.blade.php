                ...
                <div class="flex justify-center w-full">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="400" height="400"
                        ...
                        <path
                            ...
                            transform="translate(-157.896 -87.88731)" fill="#fff" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-157.896 -87.88731)" fill="#e6e6e6" />
                        <circle cx="420.52193" cy="415.57596" r="7.40884" fill="#1b3ef1" />
                        ...
                        <path
                            ...
                            transform="translate(-157.896 -87.88731)" fill="#1b3ef1" />
                        <circle cx="520.54113" cy="288.23669" r="24.07867" fill="#e6e6e6" />
                        <circle cx="678.43713" cy="376.12401" r="12.03934"
                            transform="translate(40.60032 897.66513) rotate(-80.78253)" fill="#fff" />
                        <path
                        ...
                        <circle cx="153.50003" cy="23.86253" r="11.93126" fill="#1b3ef1" />
                        <polygon points="748.119 711.24 736.687 711.239 731.25 667.143 748.123 667.145 748.119 711.24"
                            fill="#ffb8b8" />
                        <path
                            ...
                            fill="#2f2e41" />
                        <polygon points="809.741 711.24 798.308 711.239 792.872 667.143 809.745 667.145 809.741 711.24"
                            fill="#ffb8b8" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-157.896 -87.88731)" fill="#ffb8b8" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-157.896 -87.88731)" fill="#2f2e41" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-157.896 -87.88731)" fill="#1b3ef1" />
                        <path d="M1040.604,812.11269h-258a1,1,0,0,1,0-2h258a1,1,0,0,1,0,2Z"
                            transform="translate(-157.896 -87.88731)" fill="#ccc" />
                    </svg>
                </div>
            </div>
        </div>
        <div class="w-full">
            <form action="" method="post" class="flex flex-col justify-center items-center h-full ">
                <div class="w-full max-w-xl p-20">
                    ...
                    <button type="submit"
                        class="w-full rounded-xl bg-blue-600 text-white mt-5 py-3 text-center hover:bg-blue-500 transition-colors">Register</button>

                    <div class="flex mt-5 justify-center">
                        <p class="text-gray-600 font-normal">Already have an account? <a
                                class="text-blue-600 hover:underline" href="/login">Sign in</a></p>
                    </div>
                </div>
            </form>
        </div>
