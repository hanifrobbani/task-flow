                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3 text-start text-xs font-semibold text-gray-600 uppercase dark:text-neutral-500">Point</th>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                            <tr class="hover:bg-gray-100 dark:hover:bg-neutral-700">
                                ...
                                <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">Backend</td>
                                ...
                                <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">5</td>
                            ...
                            <td class="py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-200">2</td>
                                ...
                                <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">QA</td>
                            ...
                            <td class="py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-200">3</td>
                                ...
                                <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">DevOps</td>
