...
@section('main')
    <div class="w-full bg-white p-6">
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center gap-4">
                <button
                    class="border border-gray-400 rounded-full p-2 text-center text-sm hover:bg-gray-100 transition"><svg
                        class="w-6 h-6 text-gray-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
    ...
    <div class="w-full bg-white p-6 mt-5">
        ...
        <div class="grid grid-cols-2 gap-x-10 gap-y-4 mt-2">
            ...
            <div class="col-span-2">
                ...
                <p class="text-gray-600 text-sm ">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Iusto, nisi!
                    Minima ad expedita ullam fuga dolorum mollitia soluta id unde?</p>
            </div>
        </div>
