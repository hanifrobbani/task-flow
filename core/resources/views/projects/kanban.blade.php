...
@section('main')
    ...
    @if (session()->has('errorTask'))
        ...
        <button type="button" onclick="modal_create_task.showModal()"
            ...
            Add New Task</button>
        <button class="py-2 text-gray-600 font-medium text-sm flex items-center gap-1 hover:underline transition-all group">
            <svg class="group-hover:animate-spin transition-all" width="20" height="20" viewBox="0 0 24 24" fill="#25314C"
